...
public class TestUserChangeProfile {
	...
	public void test1() throws Exception {
		...
		// 使用mock对象发送POST请求
		RequestBuilder request = MockMvcRequestBuilders.post("/user/changeProfile")
				.param("id", "2").param("nick_name", "zwy").param("position", "弟弟")
				.param("sex","男").param("location","北京市 - 北京市 - 崇文区")
				.param("signature", "好好学，天天上").param("imgage", "zwy.jpg");
		...
		Assert.assertEquals(YdmaConstant.CHANGE_PROFILE_SUCCESS, ydmaResult.getMsg());
	}
